...
@section('content')
    {!! Form::model($slider, ['route' => ['admin.slider.slider.update', $slider->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            $(document).keypressAction({
                actions: [
                    { key: 'b', route: "<?= route('admin.slider.slider.index') ?>" }
                ]
            });
        });
    </script>
