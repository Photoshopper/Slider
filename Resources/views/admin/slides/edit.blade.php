...
@section('content')
    {!! Form::model($slide, ['route' => ['admin.slider.slide.update', $slide->id], 'method' => 'put', 'files' => true]) !!}
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="box-body">
                    <div class="checkbox">
                        <label for="published">
                            ...
                            {!! Form::checkbox('published', true, $slide->published, ['class' => 'flat-blue']) !!}
